  ...
  return (
    <div>
          ...
          <div className="row g-5">
            <div className="col-md-6 col-lg-6 col-xl-3">
              <div className="footer-item d-flex flex-column">
                ...
                <a href="/dashboard">
                  <i className="fas fa-angle-right me-2"></i> Encuesta
                </a>
                <a href="/dashboard">
            ...
            <div className="col-md-6 col-lg-6 col-xl-3">
              <div className="footer-item-post d-flex flex-column">
                ...
                <div className="d-flex flex-column mb-3">
                  ...
                  <a href="/dashboard" className="text-body">
            ...
            <div className="col-md-6 col-lg-6 col-xl-3">
              <div className="footer-item-post d-flex flex-column">
                ...
                <div className="footer-btn text-start">
                  <a href="/dashboard" className="btn btn-light rounded-pill px-4">
      ...
      <div className="container-fluid copyright py-4">
          ...
          <div className="row g-4 align-items-center">
            <div className="col-md-6 text-center text-md-start mb-md-0">
              <span className="text-body">
                <a href="/dashboard" className="border-bottom text-primary">
        ...
        <a href="/dashboard" className="btn btn-primary btn-lg-square back-to-top">
