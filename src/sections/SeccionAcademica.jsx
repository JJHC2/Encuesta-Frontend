  ...
  return (
    <Box sx={{ padding: 3 }}>
      <Paper elevation={3} sx={{ padding: 4 }}>
        ...
        {/* Contenedor de Grid para preguntas y respuestas */}
        <Grid container spacing={4}>
          <Grid item xs={12}>
            <PreguntaRadioGroup
              ...
              onChange={(respuesta) => HandleInputChange("capacidadDocentes", respuesta)}
            />
          </Grid>
          <Grid item xs={12}>
            <PreguntaRadioGroup
              ...
              onChange={(respuesta) => HandleInputChange("docentesPostgrado", respuesta)}
            />
          </Grid>
          <Grid item xs={12}>
            <PreguntaRadioGroup
              ...
              onChange={(respuesta) => HandleInputChange("docentesExperiencia", respuesta)}
            />
          </Grid>
          <Grid item xs={12}>
            <PreguntaRadioGroup
              ...
              onChange={(respuesta) => HandleInputChange("contenidosTeoricos", respuesta)}
            />
          </Grid>
          <Grid item xs={12}>
            <PreguntaRadioGroup
              ...
              onChange={(respuesta) => HandleInputChange("desarrolloPracticas", respuesta)}
            />
          </Grid>
        </Grid>
      </Paper>
